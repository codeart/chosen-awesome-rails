...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "Gemfile", "Gemfile.lock", "LICENSE.txt", "README.md", "Rakefile", "chosen-awesome-rails.gemspec",
    ...
    "vendor/assets/stylesheets/chosen/bootstrap3.css.scss",
